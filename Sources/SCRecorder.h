...
@protocol NeuGPUImageVideoCameraDelegate <NSObject>

@optional
- (void)willOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer;
@end
@interface SCRecorder : GPUImageOutput<AVCaptureAudioDataOutputSampleBufferDelegate, AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureFileOutputRecordingDelegate>
...
@property (weak, nonatomic) id<NeuGPUImageVideoCameraDelegate> __nullable simplebufferDelegate;
/**
...
@property (nonatomic, strong) GLKView * __nullable glkView;
/**
 Create a recorder
...
/**
 *  set the exposureTargetOffset
 *
 *  @param bias targetOffset
 */
