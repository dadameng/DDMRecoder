...
@interface SCRecordSession() {
    ...
    BOOL _nextRecordAssetNeedsLock;
...
@property (strong  , nonatomic) RecodrAsset *currentRecodrAssert;
@property (strong  , nonatomic) NSManagedObjectID *currentRecordID;
